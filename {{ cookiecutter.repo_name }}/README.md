...
│
├── pyproject.toml     <- The pyproject file for reproducing the analysis environment. It  
│                         has all the dependencies to be installed.
│
├── poetry.lock        <- The lock file generated by poetry. It will be updated after the 
